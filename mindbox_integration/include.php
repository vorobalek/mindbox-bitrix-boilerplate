...
$operationClasses = [
    'MindboxCustomerOperations',
    'MindboxOutOfStockOperations',
    'MindboxEditCustomerOperations',
    'MindboxRegisterCustomerOperations',
    'MindboxGetByCardOperations',
    'MindboxBonusPointsHistoryOperations',
];
